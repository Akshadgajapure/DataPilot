...
- NEVER infer causation from correlation. Use "associated with" rather than "causes".
- Structure all insights as: Finding → Evidence → Interpretation → Recommendation.
...
NEVER infer causation from correlation. Always use phrasing like "associated with" instead of "causes".
Format every insight as: Finding → Evidence → Interpretation → Recommendation.
...
Format as: Finding → Evidence → Interpretation → Recommendation.
...
NEVER infer causation. Format as: Finding → Evidence → Interpretation → Recommendation.

## 5. Data Quality Assessment
Comment on missing values, outliers, or anomalies found. Be specific about percentages and affected columns.

## 6. Business Opportunities
Based on the ACTUAL data findings above, what are 3 specific, actionable opportunities? Format as: Finding → Evidence → Interpretation → Recommendation.

## 7. Risks & Concerns
What data-backed risks should the business be aware of? Format as: Finding → Evidence → Interpretation → Recommendation.

## 8. Recommendations
Provide 3–5 concrete, prioritised recommendations with evidence from the data. DO NOT generate generic recommendations like "improve training" without data backing.
